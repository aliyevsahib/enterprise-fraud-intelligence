...
1) Data Simulation (Python): Generated 5 million rows of mathematically sound financial data utilizing Lognormal Distributions to accurately simulate realistic spending behaviors across Retail, Corporate, and ATM channels.
2)Big Data Processing (PySpark): Engineered custom behavioral aggregation pipelines to establish moving historical baselines for tens of thousands of unique accounts.
...
4)Command Center UI (Power BI & DAX): Designed a high-contrast, dark-mode executive dashboard utilizing advanced DAX measures, dual-axis temporal tracking, and cross-filtered UI mechanics.
